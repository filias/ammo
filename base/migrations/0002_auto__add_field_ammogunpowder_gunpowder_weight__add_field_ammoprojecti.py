...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AmmoGunpowder.gunpowder_weight'
        db.add_column(u'base_ammogunpowder', 'gunpowder_weight',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AmmoProjectile.projectile_varnish_color'
        db.add_column(u'base_ammoprojectile', 'projectile_varnish_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Deleting field 'Ammo.weight'
        db.delete_column(u'base_ammo', 'weight')

        # Deleting field 'Ammo.varnish_color'
        db.delete_column(u'base_ammo', 'varnish_color')

        # Adding field 'Ammo.fulminant_varnish_color'
        db.add_column(u'base_ammo', 'fulminant_varnish_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AmmoGunpowder.gunpowder_weight'
        db.delete_column(u'base_ammogunpowder', 'gunpowder_weight')

        # Deleting field 'AmmoProjectile.projectile_varnish_color'
        db.delete_column(u'base_ammoprojectile', 'projectile_varnish_color')

        # Adding field 'Ammo.weight'
        db.add_column(u'base_ammo', 'weight',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ammo.varnish_color'
        db.add_column(u'base_ammo', 'varnish_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Deleting field 'Ammo.fulminant_varnish_color'
        db.delete_column(u'base_ammo', 'fulminant_varnish_color')
