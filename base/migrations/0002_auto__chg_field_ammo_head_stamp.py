...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ammo.head_stamp'
        db.alter_column(u'base_ammo', 'head_stamp', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Ammo.head_stamp'
        db.alter_column(u'base_ammo', 'head_stamp', self.gf('django.db.models.fields.TextField')())
